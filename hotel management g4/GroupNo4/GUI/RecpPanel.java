...
public class RecpPanel extends JFrame implements ActionListener, MouseListener {
    ...
    // eii 'i' ta nilam roomsType and roomsNo er moddhe somporko create korar jonno
    // jate room type e "Standard" select hole shudhu "Standard" er room gula show
    // hobe... "Deluxe" select hole "Deluxe " room gula show kore..."President "
    // select hole "president room gula show korbe

    // if else er maddhome "i" eikhane row er number hisebe use korbo
    public int i;

    private String roomsNoStandard[] = { "Standard-1", "Standard-2", "Standard-3", "Standard-4", "Standard-5",
            "Standard-6", "Standard-7", "Standard-8", "Standard-9", "Standard-10",
            "Standard-11", "Standard-12", "Standard-13", "Standard-14", "Standard-15",
            "Standard-16", "Standard-17", "Standard-18", "Standard-19", "Standard-20",
            "Standard-21", "Standard-22", "Standard-23", "Standard-24", "Standard-25",
            "Standard-26", "Standard-27", "Standard-28", "Standard-29", "Standard-30",
            "Standard-31" };
    private String roomsNoDeluxe[] = { "Deluxe-1", "Deluxe-2", "Deluxe-3", "Deluxe-4", "Deluxe-5",
            "Deluxe-6", "Deluxe-7", "Deluxe-8", "Deluxe-9", "Deluxe-10",
            "Deluxe-11", "Deluxe-12", "Deluxe-13", "Deluxe-14", "Deluxe-15" };
    private String roomsNoPresident[] = { "PR. Suite-1", "PR. Suite-2", "PR. Suite-3", "PR. Suite-4",
            "PR. Suite-5",
            "PR. Suite-6" };
    ...
    RecpPanel(String Data2, String absbill, String dmc, String immc, String indiuti, String mmc, String utility) {
        this.Data2 = Data2;
        ...
        icon = new ImageIcon(getClass().getClassLoader().getResource("IMAGE/hotel_icon.png"));
        ...
        addButton.setBackground(new Color(122, 136, 164));
        ...
        deleteButton.setBackground(new Color(122, 136, 164));
        ...
        updateButton.setBackground(new Color(122, 136, 164));
        ...
        clearButton.setBackground(new Color(122, 136, 164));
        ...
        saveButton.setBackground(new Color(122, 136, 164));
        ...
        icon2 = new ImageIcon(ClassLoader.getSystemResource("IMAGE/adminpanel.png"));// pic->ImageIcon->JLabel->Cotainer
        bgpic = new JLabel(icon2);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                ...
                ImageIcon icon = new ImageIcon("IMAGE/onlinepayment.png");
                ...
                if (method == 0) {
                    ...
                    ImageIcon iconOfCard = new ImageIcon("IMAGE/card.png");
                    ...
                    ImageIcon iconOfMobileBanking = new ImageIcon("IMAGE/mobilebanking.png");
                    ...
                    if (methodOfMobileBanking.equals("BKash")) {
                        ...
                        ImageIcon iconOfCard = new ImageIcon("IMAGE/bkash.jpg");
                        ...
                        ImageIcon iconOfCard = new ImageIcon("IMAGE/Rocket.png");
                        String MobileNumber = (String) JOptionPane.showInputDialog(null, "Enter your mobile number",
                                "Mobile number", JOptionPane.QUESTION_MESSAGE, iconOfCard, null, "xxx-xxxxxxxx");// as
                        ...
                        ImageIcon iconOfCard = new ImageIcon("IMAGE/Nagad.png");
                        String MobileNumber = (String) JOptionPane.showInputDialog(null, "Enter your mobile number",
                                "Mobile number", JOptionPane.QUESTION_MESSAGE, iconOfCard, null, "xxx-xxxxxxxx");// as
