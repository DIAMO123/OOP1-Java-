...
public class Employee6 extends JFrame implements ActionListener
{
    ImageIcon icon, img,img1, image;
    Container c;
    JTable table;
    String path;
    Cursor cur;
   ...
   // DefaultTableModel model;
    ...
    JLabel titleLabel, fnLabel, lnLabel, phoneLabel, gndLabel, nidLabel,
            daysPerWeekLabel, positionLabel, incomeLabel, bgpic,mpic;
    ...
    Employee6()
    {
        ...
        daysPerWeekTf = new JTextField("Sun,Mon,Thu");
        daysPerWeekTf.setBounds(155, 330, 160, 30);
        ...
        //Backgroud Image
        img =new ImageIcon(ClassLoader.getSystemResource("IMAGE/itc-maurya.png"));
