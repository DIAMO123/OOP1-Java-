...
public class Employee3 extends JFrame implements ActionListener
{
   ...
   // DefaultTableModel model;
    ...
    Employee3()
    {
       ...
       // this part changes the icon
        ...
        daysPerWeekTf = new JTextField("Sun,Thu,Wed");
        ...
        incomeTf = new JTextField("250000tk");
