   ...
   // DefaultTableModel model;
    ...
    Employee4()
    {
       ...
       // icon=new ImageIcon(getClass().getClassLoader().getResource("IMAGE/hotel_icon.png")); //Interface Icon Location
        ...
        daysPerWeekTf = new JTextField("Sat,Sun,tue");
        daysPerWeekTf.setBounds(110, 330, 160, 30);
        ...
        incomeTf = new JTextField("90000tk");
        ...
        //Backgroud Image
        img =new ImageIcon(ClassLoader.getSystemResource("IMAGE/facade.png"));
