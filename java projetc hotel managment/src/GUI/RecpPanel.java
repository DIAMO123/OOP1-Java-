...
public class RecpPanel extends JFrame implements ActionListener, MouseListener {
    ...
    RecpPanel(String Data2, String absbill, String dmc, String immc, String indiuti, String mmc, String utility) {
		...
		c.setBackground(Color.BLACK);// set Background Color
        c.setLayout(null);
        ...
        icon2 = new ImageIcon(ClassLoader.getSystemResource("IMAGE/Hotel_img1.jp"));// pic->ImageIcon->JLabel->Cotainer
        bgpic = new JLabel(icon2);
        bgpic.setBounds(0, 0, 1370, 920);
        c.add(bgpic);
